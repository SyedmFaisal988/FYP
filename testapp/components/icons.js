...
const Envalop = props => (
  ...
  const Subtract = props => (
    <Svg width={16} height={16} viewBox="0 0 16 16" {...props}>
      <Path scale={0.02} d="M535.5 229.5h-459C34.253 229.5 0 263.753 0 306s34.253 76.5 76.5 76.5h459c42.247 0 76.5-34.253 76.5-76.5s-34.253-76.5-76.5-76.5z" />
    </Svg>
  )
  
  const Add = props => (
    <Svg height="16" viewBox="0 0 16 16" width="16" {...props}>
      <Path scale={0.03} d="M408 184H272a8 8 0 01-8-8V40c0-22.09-17.91-40-40-40s-40 17.91-40 40v136a8 8 0 01-8 8H40c-22.09 0-40 17.91-40 40s17.91 40 40 40h136a8 8 0 018 8v136c0 22.09 17.91 40 40 40s40-17.91 40-40V272a8 8 0 018-8h136c22.09 0 40-17.91 40-40s-17.91-40-40-40zm0 0" />
    </Svg>
  )
  ...
  const Filter = props => {
    return (
      <Svg height={32} viewBox="0 0 32 32" width={32} {...props}>
        <Path scale={0.07} d="M362.072 63c.1-.3-.1-.6-.1-.9V10c.2-5.3-4-9.8-9.4-10h-315c-5.3 0-9.7 4.4-9.6 9.7v52.4c0 .3-.2.6-.1.9 0 .1-.1.3 0 .4v.5c0 .2 0 .3.1.5s.1.3.1.4c0 .1.1.3.1.5 0 .1.1.3.1.4.1.2.1.3.2.5.1.1.1.3.2.4.1.1.1.3.2.4.1.1.2.3.2.4 0 .1.2.3.2.4.1.1.2.3.3.4s.2.2.2.3c0 0 .2 0 .3.1l119.9 141V380c-.1 3.8 2 7.3 5.5 9 1.3.6 2.7 1 4.2 1 2.3 0 4.5-.8 6.2-2.2l70.6-57.3c2.3-1.9 3.6-4.8 3.5-7.8V209.6l119.8-141s.1 0 .2-.1l.3-.3c.1-.1.2-.3.3-.4s.2-.3.3-.4c.1-.1.2-.3.2-.4.1-.1.2-.3.2-.4.1-.1.1-.3.2-.4.1-.2.1-.3.2-.5.1-.1.1-.3.1-.4.1-.2.1-.3.1-.5s.1-.3.1-.4c0-.1.1-.3.1-.5s.1-.4.1-.5c0-.1-.2-.3-.1-.4zm-139.5 136.4c-1.6 1.8-2.5 4.1-2.6 6.5v112l-50 41.1V205.9c-.1-2.4-1-4.7-2.6-6.5L59.172 72h271.6l-108.2 127.4zM341.972 52h-294V20h294v32z" />
      </Svg>
    )
  }
  ...
  const Check = props => 
      <Svg height={20} viewBox="0 0 20 20" width={20} {...props}>
        <Path scale={0.04} d="M159.988 318.582c-3.988 4.012-9.43 6.25-15.082 6.25s-11.094-2.238-15.082-6.25L9.375 198.113c-12.5-12.5-12.5-32.77 0-45.246l15.082-15.086c12.504-12.5 32.75-12.5 45.25 0l75.2 75.203L348.104 9.781c12.504-12.5 32.77-12.5 45.25 0l15.082 15.086c12.5 12.5 12.5 32.766 0 45.246zm0 0" />
      </Svg>

  export { Envalop, Password, Phone, UserAvatar, Camera, Search, Favourite, BackArrow, Subtract, Add, Menu, Filter, Check };